package com.bigdata.window.trigger
...
class CustomTrigger extends Trigger[RawData, TimeWindow] {
  ...
  override def onElement(element: RawData, timestamp: Long, window: TimeWindow, ctx: Trigger.TriggerContext): TriggerResult = {
