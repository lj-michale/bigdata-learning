package com.bigdata.connector.kafka
...
/**
 * @descr ExactlyOnceExample
 * @author lj.michale
 * @date 2021-06
 */
object ExactlyOnceExample {

  val logger = Logger.getLogger(ExactlyOnceExample.getClass)
  ...
  def main(args: Array[String]): Unit = {
    ...
    ConnectionPool.singleton("jdbc:mysql://localhost/bigdata?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true&allowPublicKeyRetrieval=true", "root", "abc1314520")
