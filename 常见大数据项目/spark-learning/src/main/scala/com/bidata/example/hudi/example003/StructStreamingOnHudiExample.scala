...
/**
 * @descr StructStreamingOnHudiExample
 * @author lj.michale
 * @date 2021-06
 */
object StructStreamingOnHudiExample {

  val logger = Logger.getLogger(StructStreamingOnHudiExample.getClass)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = dataStreamReader.load()
      .selectExpr("topic as kafka_topic",
    ...
    val query = df
      .writeStream
      .queryName("demo")
//      .foreach((batchDF: DataFrame, _: Long) => {
//        batchDF.persist()
//
