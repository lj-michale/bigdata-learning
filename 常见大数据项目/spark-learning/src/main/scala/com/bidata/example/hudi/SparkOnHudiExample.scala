package com.bidata.example.hudi
 ...
 * @description
 *             spark结构化流+Hudi
 *             由于Hudi OutputFormat目前只支持在spark rdd对象中调用，因此写入HDFS操作采用了spark structured streaming的forEachBatch算子
 * @date 2021-05-31
 */
object SparkOnHudiExample {

  val logger = Logger.getLogger(SparkOnHudiExample.getClass)
